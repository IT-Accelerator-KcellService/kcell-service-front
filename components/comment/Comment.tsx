                            ...
                            return (
                                <div
                                    ...
                                    className={`flex items-start gap-2.5 group relative transition-colors duration-150 ${
                                        activeCommentId === c.id ? "bg-brand-light" : "hover:bg-gray-50"
                                    }`}
                                ...
                                >
                                    {/* Аватарка */}
                                    <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-br from-brand-teal to-brand-black rounded-full flex items-center justify-center">
