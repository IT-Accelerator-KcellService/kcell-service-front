...
export const IconInfoModal: React.FC<IconInfoModalProps> = ({ isOpen, onClose, iconInfo, isDesktop }) => {
  ...
  const getStatusIcon = (status: string) => {
    ...
    switch (status.toLowerCase()) {
      ...
      case "in_progress":
      case "execution":
        return <Loader2 className={`${iconClass} text-[#114A65] animate-spin`} />
        ...
        <div className="relative bg-white w-full max-w-sm mx-2 mb-2 sm:mb-0 rounded-t-3xl sm:rounded-3xl shadow-2xl animate-in slide-in-from-bottom-4 sm:slide-in-from-bottom-0 sm:zoom-in-95 duration-200">
          ...
          <div className="p-6 pt-8">
            ...
            <div className="flex items-start gap-4 mb-6">
              <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#114A65]/10 to-[#B8400E]/10 rounded-2xl flex items-center justify-center">
                {iconInfo.type === "status" ? (
                    ...
                    <Hourglass className="w-5 h-5 text-[#114A65]" />
                )}
              </div>
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[#114A65] font-medium text-base">{iconInfo.value}</p>
              </div>
            </div>
            ...
            {iconInfo.type === "status" && (
                <div className="space-y-3 mb-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 transition-colors">
                      <Loader2 className="w-4 h-4 text-[#114A65] flex-shrink-0 animate-spin" />
                      <div className="min-w-0">
            ...
            {iconInfo.type === "longTerm" && (
                <div className="mb-6 p-4 bg-gradient-to-br from-[#114A65]/10 to-[#B8400E]/10 rounded-2xl">
            ...
            <Button
                onClick={onClose}
                className="w-full h-12 bg-gradient-to-r from-[#114A65] to-[#B8400E] hover:from-[#0d3a4f] hover:to-[#A3390D] text-white font-medium rounded-2xl transition-colors shadow-none border-0"
            >
              Понятно
            </Button>
          </div>
